"""
spdp_monotone_dnf.py

Computes the SPDP rank for a monotone DNF formula:
    f(x) = x0*x1 + x2*x3

This tests how SPDP handles disjunctions of conjunctions
(common in many shallow circuits and logic representations).
...
dnf_expr = sp.expand(x0 * x1 + x2 * x3)
...
# Run test
compute_spdp(dnf_expr, "Monotone DNF")
