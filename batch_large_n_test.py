#!/usr/bin/env python3
"""
batch_large_n_test.py

Runs large-n SPDP rank tests on structured circuits (e.g., majority, addressing) to check
whether collapse persists at scale. Used to validate scalability of the P ≠ NP collapse claim.
"""
...
def run_large_n():
    ...
    print(df)
    df.to_csv("large_n_summary.csv", index=False)
